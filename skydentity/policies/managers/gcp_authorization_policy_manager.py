...
class GCPAuthorizationPolicyManager(PolicyManager):
    ...
    def generate_capability(self, service_account_id: str) -> dict:
        ...
        dict_values = [
            ...
            for x in (cipher.nonce, header, capability, tag)
        ]
    ...
    def create_service_account_with_roles(
        self, authorization: GCPAuthorizationPolicy
    ) -> str:
        """
        ...
        """
        gcp_service_account_manager = GCPServiceAccountManager(
        ...
        gcp_service_account_manager.create_service_account(
            authorization=authorization, service_account_name=account_name
        )
        ...
        account_email = (
            f"{account_name}@{authorization._policy.project}.iam.gserviceaccount.com"
        )
